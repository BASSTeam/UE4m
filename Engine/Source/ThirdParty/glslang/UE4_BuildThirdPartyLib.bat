...
pushd glslang\projects
	...
	REM vs2013 x64
	pushd vs2013
	msbuild glslang.sln /target:Clean,glslang_lib /m /p:Platform=x64;Configuration="Release"
	msbuild glslang.sln /target:Clean,glslang_lib /m /p:Platform=x64;Configuration="Debug"
	popd
